...
(function(b) {
    var d = function(b) {
        ...
        a.prototype.push = function(c) {
            var k = this.objectPool; - 1 == k.indexOf(c) && (k.push(c), this._length++, 0 == this.frameCount && (this.frameCount =
        ...
        a.prototype.dispose = function() {
            ...
            var c = a._callBackList,
                k = c.indexOf(this); - 1 != k && c.splice(k, 1)
        };
        a._callBackList = [];
        return a
    }(b.HashObject);
...
(function(b) {
    var d = function(e) {
        ...
        a._dispatchByTarget = function(c, a, f, n, e, d) {
            void 0 === e && (e = !1);
            void 0 === d && (d = !1);
            var h = c.eventRecycler;
            h || (h = c.eventRecycler = new b.Recycler);
            var m = h.pop();
            m ? m._type = f : m = new c(f);
            m._bubbles = e;
            m._cancelable = d;
            if (n)
                for (var p in n) m[p] = n[p], null !== m[p] && (n[p] = null);
            c = a.dispatchEvent(m);
            h.push(m);
            return c
        };
        ...
        a.dispatchEvent = function(c, k, f, b) {
            void 0 === f && (f = !1);
...
(function(b) {
    var d = function(e) {
        function a(c, a, f, b, d, g, h, m, p, q) {
            void 0 === a && (a = !0);
            void 0 === f && (f = !0);
            void 0 === b && (b = 0);
            void 0 === d && (d = 0);
        ...
        a.dispatchTouchEvent = function(c, k, f, e, d, g, h, m, p) {
            void 0 === f && (f = 0);
            void 0 === e && (e = 0);
            void 0 === d && (d = 0);
            void 0 === g && (g = !1);
...
(function(b) {
    var d = function(e) {
        ...
        __extends(a, e);
        a.dispatchProgressEvent = function(c, k, f, e) {
            void 0 === f && (f = 0);
            void 0 === e && (e = 0);
            b.Event._dispatchByTarget(a, c, k, {
                bytesLoaded: f,
...
(function(b) {
    var d = function(e) {
        ...
        __extends(a, e);
        a.prototype.addEventListener = function(c, a, f, e, d) {
            void 0 === e && (e = !1);
            void 0 === d && (d = 0);
            ...
            var g = e[c];
            g || (g = e[c] = []);
            this._insertEventBin(g, a, f, d)
        };
        a.prototype._insertEventBin = function(c, a, f, b, e) {
            void 0 === e && (e = void 0);
            for (var d = -1, h = c.length, m = 0; m < h; m++) {
                var p = c[m];
                if (p.listener === a && p.thisObject === f && p.display === e) return !1; - 1 == d && p.priority < b && (d = m)
            }
            a = {
                listener: a,
                thisObject: f,
            ...
            e && (a.display = e); - 1 != d ? c.splice(d, 0, a) : c.push(a);
            return !0
        };
        a.prototype.removeEventListener = function(c, a, f, b) {
            void 0 === b && (b = !1);
            if (b = b ? this._captureEventsMap : this._eventsMap) {
                var e = b[c];
                e && (this._removeEventBin(e,
                    a, f), 0 == e.length && delete b[c])
            }
        };
        a.prototype._removeEventBin = function(c, a, f, b) {
            void 0 === b && (b = void 0);
            for (var e = c.length, d = 0; d < e; d++) {
                var h = c[d];
                if (h.listener === a && h.thisObject === f && h.display === b) return c.splice(d, 1), !0
            }
            return !1
        };
        ...
        a.prototype.dispatchEventWith = function(c, a, f) {
            void 0 === a && (a = !1);
            b.Event.dispatchEvent(this, c, a, f)
        };
        return a
    }(b.HashObject);
    b.EventDispatcher = d;
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.broadcastEnterFrame = function(c) {
            ...
            for (var a = b.DisplayObject._enterFrameCallBackList.concat(), f = a.length, e = 0; e < f; e++) {
                var d = a[e];
                c._target = d.display;
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.register = function(c, a, f) {
            void 0 === f &&
                (f = 0);
            this._insertEventBin(this.callBackList, c, a, f)
        };
        a.prototype.unregister = function(c, a) {
            this._removeEventBin(this.callBackList, c, a)
        };
        a.prototype.setTimeout = function(c, a, f) {
            for (var e = [], d = 3; d < arguments.length; d++) e[d - 3] = arguments[d];
            b.Logger.warning("Ticker#setTimeout\u65b9\u6cd5\u5373\u5c06\u5e9f\u5f03,\u8bf7\u4f7f\u7528egret.setTimeout");
            b.setTimeout.apply(null, [c, a, f].concat(e))
        };
...
(function(b) {
    ...
    b.getDefinitionByName = function(b) {
        ...
        var a = d[b];
        if (a) return a;
        for (var c = b.split("."), k = c.length, a = __global, f = 0; f < k; f++)
            if (a = a[c[f]], !a) return null;
        return d[b] = a
    }
})(egret || (egret = {}));
...
(function(b) {
    ...
    var e = {},
        a = 0;
    b.setTimeout = function(c, k, f) {
        for (var n = [], l = 3; l < arguments.length; l++) n[l - 3] = arguments[l];
        n = {
            listener: c,
            thisObject: k,
            delay: f,
...
(function(b) {
    var d = function(e) {
        ...
        __extends(a, e);
        a.prototype.prepend = function(c, a, f, b, e, d) {
            var h = this.tx;
            if (1 != c || 0 != a || 0 != f || 1 != b) {
                var m = this.a,
                    p = this.c;
            ...
            this.tx = h * c + this.ty * f + e;
            this.ty = h * a + this.ty * b + d;
            return this
        };
        a.prototype.append =
            function(c, a, f, b, e, d) {
                var h = this.a,
                    m = this.b,
                    p = this.c,
                    q = this.d;
                if (1 != c || 0 != a || 0 != f || 1 != b) this.a = c * h + a * p, this.b = c * m + a * q, this.c = f * h + b * p, this.d = f * m + b * q;
                this.tx = e * h + d * p + this.tx;
                this.ty = e * m + d * q + this.ty;
                return this
        };
        a.prototype.prependTransform = function(c, a, f, e, d, g, h, m, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1, d = 0; if (m || p) this.tx -= m, this.ty -= p;
            g || h ? (this.prepend(q * f, d * f, -d * e, q * e, 0, 0), this.prepend(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(g), b.NumberUtils.cos(g),
                c, a)) : this.prepend(q * f, d * f, -d * e, q * e, c, a);
            return this
        };
        a.prototype.appendTransform = function(c, a, f, e, d, g, h, m, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1, d = 0;
            g || h ? (this.append(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(g), b.NumberUtils.cos(g), c, a), this.append(q * f, d * f, -d * e, q * e, 0, 0)) : this.append(q * f, d * f, -d * e, q * e, c, a);
        ...
        a.prototype.invert = function() {
            ...
            this.c = -b / g;
            this.d = c / g;
            this.tx = (b * this.ty - e * d) / g;
            this.ty = -(c * this.ty - a * d) / g;
            return this
        };
        a.transformCoords = function(c, a, f) {
            var e = b.Point.identity;
            e.x = c.a * a + c.c * f + c.tx;
            e.y = c.d * f + c.b * a + c.ty;
            return e
        };
...
(function(b) {
    ...
    e = function() {
        ...
        c.prototype.init = function(c) {};
        c.prototype._apply = function(c, a, k) {};
        c.prototype.setEgretSize = function(c, a, k, f, e, p) {
            void 0 === p && (p = 0);
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.drawImage = function(c, a, f, e, d, g, h, m, p, q, r) {
            void 0 === r && (r = void 0);
            h = h || 0;
            m = m || 0;
            var t = a._texture_to_render;
            if (null != t && 0 != g && 0 != d && 0 != p && 0 != q) {
                ...
                if (0 != this._drawAreaList.length && b.MainContext.instance.rendererContext._cacheCanvasContext) {
                    ...
                    for (var u = this.getDrawAreaList(), v = 0; v < u.length; v++)
                        if (!this.ignoreRender(a, u[v], s.destX, s.destY)) {
                            c.drawImage(t, f, e, d, g, h, m, p, q, r);
                            break
                        }
                } else c.drawImage(t, f, e, d, g, h, m, p, q, r)
            }
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.drawCacheTexture =
            function(c) {
                ...
                b.RenderFilter.getInstance().drawImage(c, this, 0, 0, d * g, a * g, f, e, d, a);
                return !0
        };
        ...
        a.prototype.getBounds =
            function(c, a) {
                void 0 === a && (a = !0);
                var f = this._measureBounds(),
                    e = this._hasWidthSet ? this._explicitWidth : f.width,
                    d = this._hasHeightSet ? this._explicitHeight : f.height;
                this._rectW = f.width;
                this._rectH = f.height;
                this._clearSizeDirty();
                var g = f.x,
                    f = f.y,
                    h = 0,
                    m = 0;
                a && (0 != this._anchorX || 0 != this._anchorY ? (h = e * this._anchorX, m = d * this._anchorY) : (h = this._anchorOffsetX, m = this._anchorOffsetY));
                this._cacheBounds.initialize(g - h, f - m, e, d);
                e = this._cacheBounds;
                c || (c = new b.Rectangle);
        ...
        a.prototype._getConcatenatedMatrix = function() {
            for (var c = a.identityMatrixForGetConcatenated.identity(), k = this; null != k;) {
                if (0 != k._anchorX || 0 != k._anchorY) {
                    var f = k._getSize(b.Rectangle.identity);
                    c.prependTransform(k._x, k._y, k._scaleX, k._scaleY, k._rotation, k._skewX, k._skewY, f.width * k._anchorX, f.height * k._anchorY)
                } else c.prependTransform(k._x, k._y, k._scaleX, k._scaleY,
                    k._rotation, k._skewX, k._skewY, k._anchorOffsetX, k._anchorOffsetY);
                k._scrollRect && c.prepend(1, 0, 0, 1, -k._scrollRect.x, -k._scrollRect.y);
                k = k._parent
            }
            return c
        };
        a.prototype.localToGlobal = function(c, a, f) {
            void 0 === c && (c = 0);
            void 0 === a && (a = 0);
        ...
        a.prototype.globalToLocal = function(c, a, f) {
            void 0 === c && (c = 0);
            void 0 === a && (a = 0);
            var e = this._getConcatenatedMatrix();
            e.invert();
        ...
        a.prototype.hitTest = function(c, a, f) {
            void 0 === f && (f = !1);
            if (!this._visible || !f && !this._touchEnabled) return null;
            f = this._getSize(b.Rectangle.identity);
            return 0 <= c && c < f.width && 0 <= a && a < f.height ? this.mask || this._scrollRect ? this._scrollRect && c > this._scrollRect.x && a > this._scrollRect.y && c < this._scrollRect.x + this._scrollRect.width && a < this._scrollRect.y + this._scrollRect.height || this.mask && this.mask.x <= c && c < this.mask.x + this.mask.width && this.mask.y <= a && a < this.mask.y + this.mask.height ?
                this : null : this : null
        };
        a.prototype.hitTestPoint = function(c, a, f) {
            c = this.globalToLocal(c, a);
            return f ? (this._hitTestPointTexture || (this._hitTestPointTexture = new b.RenderTexture), f = this._hitTestPointTexture, f.drawToTexture(this), 0 != f.getPixel32(c.x - this._hitTestPointTexture._offsetX, c.y - this._hitTestPointTexture._offsetY)[3] ? !0 : !1) : !!this.hitTest(c.x, c.y, !0)
        };
        a.prototype._getMatrix = function(c) {
            c || (c = b.Matrix.identity.identity());
            var a, f;
            f = this._getOffsetPoint();
            a = f.x;
            f = f.y;
            var e = this.__hack_local_matrix;
            e ? (c.append(e.a, e.b, e.c, e.d, e.tx, e.ty), c.append(1, 0, 0, 1, -a, -f)) : c.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, f);
            return c
        };
        ...
        a.prototype.addEventListener = function(c, k, f, d, l) {
            void 0 === d && (d = !1);
            void 0 === l && (l = 0);
            e.prototype.addEventListener.call(this, c, k, f, d, l);
            ((d = c == b.Event.ENTER_FRAME) || c == b.Event.RENDER) && this._insertEventBin(d ? a._enterFrameCallBackList : a._renderCallBackList, k, f, l, this)
        };
        a.prototype.removeEventListener =
            function(c, k, f, d) {
                void 0 === d && (d = !1);
                e.prototype.removeEventListener.call(this, c, k, f, d);
                ((d = c == b.Event.ENTER_FRAME) || c == b.Event.RENDER) && this._removeEventBin(d ? a._enterFrameCallBackList : a._renderCallBackList, k, f, this)
        };
        a.prototype.dispatchEvent = function(c) {
            if (!c._bubbles) return e.prototype.dispatchEvent.call(this, c);
        ...
        a.prototype._dispatchPropagationEvent = function(c, a, b) {
            ...
            if (!c._isPropagationStopped && !c._isPropagationImmediateStopped)
                for (e = 3, d = 1; d < b && (g = a[d], c._currentTarget = g, c._target = this, c._eventPhase = e, g._notifyListener(c), !c._isPropagationStopped && !c._isPropagationImmediateStopped); d++);
        };
    ...
    d = function() {
        ...
        b.prototype.updateColor = function(a, c, k, b, e, d, g, h) {};
        return b
    }();
    b.ColorTransform = d;
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.doSetChildIndex = function(c,
            a) {
            var f = this._children.indexOf(c);
        ...
        a.prototype._doAddChild = function(c, k, f) {
            void 0 === f && (f = !0);
            if (c == this) return c;
            if (0 > k || k > this._children.length) return b.Logger.fatal("\u63d0\u4f9b\u7684\u7d22\u5f15\u8d85\u51fa\u8303\u56f4"),
                c;
            var e = c._parent;
            if (e == this) return this.doSetChildIndex(c, k), c;
            e && (k = e._children.indexOf(c), 0 <= k && e._doRemoveChild(k));
            this._children.splice(k, 0, c);
            c._parentChanged(this);
            f && c.dispatchEventWith(b.Event.ADDED, !0);
            if (this._stage)
                for (c._onAddToStage(), k = a.__EVENT__ADD_TO_STAGE_LIST; 0 < k.length;) k.shift().dispatchEventWith(b.Event.ADDED_TO_STAGE);
            c._setDirty();
            this._setSizeDirty();
            return c
        };
        ...
        a.prototype._doRemoveChild = function(c, k) {
            ...
            if (this._stage) {
                ...
                for (var d = a.__EVENT__REMOVE_FROM_STAGE_LIST; 0 < d.length;) {
                    var g = d.shift();
                    g.dispatchEventWith(b.Event.REMOVED_FROM_STAGE);
                    g._stage = null
                }
            }
        ...
        a.prototype.swapChildren = function(c, a) {
            var f = this._children.indexOf(c),
                e = this._children.indexOf(a); - 1 == f || -1 == e ? b.Logger.fatal("child\u672a\u88abaddChild\u5230\u8be5parent") : this._swapChildrenAt(f, e)
        };
        ...
        a.prototype._measureBounds = function() {
            for (var c = 0, a = 0, f = 0, e = 0, d = this._children.length, g = 0; g < d; g++) {
            ...
            return b.Rectangle.identity.initialize(c, f, a - c, e - f)
        };
        a.prototype.hitTest = function(c, a, f) {
            void 0 === f && (f = !1);
            var d;
            ...
            for (var l = this._children, g = this._touchChildren, h = l.length - 1; 0 <= h; h--) {
                var m = l[h],
                    p = m._getMatrix(),
                    q = m._scrollRect;
            ...
            return d ? d : this._texture_to_render || this.graphics ? e.prototype.hitTest.call(this, c, a, f) : null
        };
        a.prototype._onAddToStage = function() {
    ...
    var d = function(e) {
        ...
        a.prototype.hitTest = function(c, a, f) {
            ...
            for (var d = f.length - 1; 0 <= d; d--) {
                ...
                g.invert();
                g = b.Matrix.transformCoords(g, c, a);
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.setContent = function(c) {
            this._content !== c && (this.removeContent(), c && (this._content = c, e.prototype.addChild.call(this,
                c), this._addEvents()))
        };
        ...
        a.prototype._onTouchBeginCapture = function(c) {
            ...
            if (k) {
                for (var f = c.target; f != this;) {
                    if (f instanceof a && (k = f._checkScrollPolicy())) return;
                    f = f.parent
                }
                c.stopPropagation();
        ...
        a.prototype._calcVelocitys = function(c) {
            ...
            if (0 == this._lastTouchTime) this._lastTouchTime = a;
                ...
                var f = this._getPointChange(c),
                    a = a - this._lastTouchTime;
                f.x /= a;
                f.y /= a;
                this._velocitys.push(f);
        ...
        a.prototype._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                for (var c = 0, b = 0, f = 0, e = 0; e < this._velocitys.length; e++) var d = this._velocitys[e],
                    g = a.weight[e],
                    c = c + d.x * g,
                    b = b + d.y * g,
                    f = f + g;
                ...
                c = 0.02 < d ? this.getAnimationDatas(c, this._scrollLeft, g) : {
                    position: this._scrollLeft,
                    duration: 1
                };
                b = 0.02 < f ? this.getAnimationDatas(b, this._scrollTop, e) : {
        ...
        a.prototype.setScrollTop = function(c, a) {
            void 0 === a && (a = 0);
            var f = Math.min(this.getMaxScrollTop(), Math.max(c,
                0));
            if (0 == a) return this.scrollTop = f, null;
        ...
        a.prototype.setScrollLeft = function(c, a) {
            void 0 === a && (a = 0);
            var f = Math.min(this.getMaxScrollLeft(), Math.max(c, 0));
            if (0 == a) return this.scrollLeft = f, null;
            var e = b.Tween.get(this).to({
                scrollLeft: c
            }, a, b.Ease.quartOut);
            f != c && e.to({
        ...
        a.prototype.getAnimationDatas = function(c, a, b) {
            ...
            if (0 > g || g > b)
                for (g =
                    a; Infinity != Math.abs(c) && 0.02 < Math.abs(c);) g += c, c = 0 > g || g > b ? 0.998 * c * 0.95 : 0.998 * c, d++;
            else d = 500 * -Math.log(0.02 / e);
            return {
                position: Math.min(b + 50, Math.max(g, -50)),
                duration: d
            }
        };
        ...
        a.prototype.hitTest = function(c, a, f) {
            void 0 === f && (f = !1);
            var d = e.prototype.hitTest.call(this, c, a, f);
            return d ? d : b.DisplayObject.prototype.hitTest.call(this, c, a, f)
        };
...
(function(b) {
    var d = function(e) {
        ...
        a._drawBitmap = function(c, b, f, e) {
            var d = e._texture_to_render;
            if (d) {
                var g = d._textureWidth,
                    h = d._textureHeight;
                if ("scale" == e.fillMode) {
                    var m = e.scale9Grid || d.scale9Grid;
                    if (m && g - m.width < b && h - m.height < f) a.drawScale9GridImage(c, e, m, b, f);
                    else {
                        var m = d._offsetX,
                            p = d._offsetY,
                            q = d._bitmapWidth || g,
                        ...
                        a.renderFilter.drawImage(c,
                            e, d._bitmapX, d._bitmapY, q, r, m, p, b, f)
                    }
                } else a.drawRepeatImage(c, e, b, f, e.fillMode)
            }
        };
        a.drawRepeatImage = function(c, a, f, e, d) {
            ...
            if (g) {
                var h = g._textureWidth,
                    ...
                    r = g._offsetX,
                    g = g._offsetY;
                b.RenderFilter.getInstance().drawImage(c, a, p, q, h, m, r, g, f, e, d)
            }
        };
        a.drawScale9GridImage = function(c, a, f, e, d) {
            var g = a._texture_to_render;
            if (g && f) {
                ...
                f.x == f.right && (f.right < t ? f.right++ : f.x--);
                var m = q + f.x,
                    p = q + f.right,
                    x = t - f.right,
                    y = r + f.y,
                    ...
                    t = e - (t - f.right);
                h.drawImage(c,
                    a, q / g, r / g, f.x, f.y, u, v, f.x, f.y);
                h.drawImage(c, a, m / g, r / g, f.width, f.y, A, v, t - f.x, f.y);
                h.drawImage(c, a, p / g, r / g, x, f.y, u + t, v, e - t, f.y);
                h.drawImage(c, a, q / g, y / g, f.x, f.height, u, B, f.x, s - f.y);
                h.drawImage(c, a, m / g, y / g, f.width, f.height, A, B, t - f.x, s - f.y);
                h.drawImage(c, a, p / g, y / g, x, f.height, u + t, B, e - t, s - f.y);
                h.drawImage(c, a, q / g, w / g, f.x, z, u, v + s, f.x, d - s);
                h.drawImage(c, a, m / g, w / g, f.width, z, A, v + s, t - f.x, d - s);
                h.drawImage(c, a, p / g, w / g, x, z, u + t, v + s, e - t, d - s)
            }
        };
        a.prototype._measureBounds = function() {
            var c = this._texture;
            return c ? b.Rectangle.identity.initialize(c._offsetX,
                c._offsetY, c._textureWidth, c._textureHeight) : e.prototype._measureBounds.call(this)
        };
        a.debug = !1;
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype._renderText = function(c) {
            ...
            for (var f = 0, e = this.text.length; f < e; f++) {
                var d = this.text.charAt(f),
                    g = this.spriteSheet.getTexture(d);
                if (null == g) console.log("\u5f53\u524d\u6ca1\u6709\u4f4d\u56fe\u6587\u5b57\uff1a" +
                    d);
                else {
                    var d = g._offsetX,
                        h = g._offsetY,
                    ...
                    c += m + d;
                    h + g._textureHeight > a && (a = h + g._textureHeight)
                }
            }
...
(function(b) {
    var d = function() {
        ...
        b.prototype.drawRect = function(a, c, b, f) {
            this.checkRect(a, c, b, f)
        };
        b.prototype.drawCircle = function(a, c, b) {
            this.checkRect(a - b, c - b, 2 * b, 2 * b)
        };
        b.prototype.drawRoundRect = function(a, c, b, f, e, d) {
            this.checkRect(a, c, b, f)
        };
        b.prototype.drawEllipse = function(a, c, b, f) {
            this.checkRect(a - b, c - f, 2 * b, 2 * f)
        };
        b.prototype.lineStyle =
            function(a, c, b, f, e, d, g, h) {};
        b.prototype.lineTo = function(a, c) {
            this.checkPoint(a, c)
        };
        b.prototype.curveTo = function(a, c, b, f) {
            this.checkPoint(a, c);
            this.checkPoint(b, f)
        };
    ...
    var d = function(e) {
        ...
        Object.defineProperty(a.prototype, "textFlow", {
            ...
            set: function(c) {
                ...
                var a = "";
                null == c && (c = []);
                for (var b = 0; b < c.length; b++) a += c[b].text;
        ...
        a.prototype.changeToPassText = function(c) {
            if (this._displayAsPassword) {
                for (var a = "", b = 0, e = c.length; b < e; b++) switch (c.charAt(b)) {
                    case "\n":
                        a += "\n";
                        break;
                    case "\r":
            ...
            function() {
                ...
                for (var m = 0; m < c.length; m++) {
                    ...
                    for (var q =
                        ...
                        d = this._type == b.TextFieldType.INPUT ? this._size : Math.max(d, p.style.size || this._size);
                        if ("" != q[r]) {
                        ...
                        if (r < q.length - 1) {
                            ...
                            this._textMaxHeight += d;
                            if (this._type == b.TextFieldType.INPUT && !this._multiline) return this._numLines = f.length, f;
                            g++
                        }
                    }
                    m == c.length - 1 && h && (h.width = e, h.height = d, this._textMaxWidth = Math.max(this._textMaxWidth, e), this._textMaxHeight += d)
                }
                this._numLines = f.length;
                return f
        };
        ...
        a.prototype.drawText = function(c) {
            ...
            if (a) {
                ...
                var f = this._hasWidthSet ? this._explicitWidth : this._textMaxWidth,
                ...
                for (h = 0; g < this._numLines; g++) {
                    var m = a[g],
                        p = m.height,
                        d = d + p / 2;
                    if (0 != g && this._hasHeightSet &&
                        d > this._explicitHeight) break;
                    for (var h = Math.round((f - m.width) * e), q = 0; q < m.elements.length; q++) {
                        var r = m.elements[q],
                            t = r.style.size || this._size;
                        this._type == b.TextFieldType.INPUT ? c.drawText(this, r.text, h, d + (p - t) / 2, r.width) : (this._isFlow && c.setupFont(this, r.style), c.drawText(this, r.text, h, d + (p - t) / 2, r.width, r.style));
                        h += r.width
                    }
                    d += p / 2 + this._lineSpacing
                }
            }
        };
    ...
    var d = function() {
        ...
        b.prototype.parser = function(a) {
            ...
            for (var c = 0, b = a.length; c < b;) {
                var f = a.indexOf("<", c);
                0 > f ? (this.addToResultArr(a.substring(c)), c = b) : (this.addToResultArr(a.substring(c, f)), c = a.indexOf(">", f), "/" == a.charAt(f + 1) ? this.stackArray.pop() : this.addToArray(a.substring(f + 1, c)), c += 1)
            }
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.createTexture = function(c, a, f, e, d, g, h, m, p) {
            void 0 === g && (g = 0);
            void 0 === h && (h = 0);
            "undefined" === typeof m && (m = g + e);
    ...
    var d = function(e) {
        ...
        a.prototype._updateProperties = function() {
            ...
            if (null == c) this.stageText._setVisible(!1);
                ...
                for (var a = this._text, f = a._visible; f;) {
                    a = a.parent;
                    if (a == c) break;
                    f = a._visible
                }
                this.stageText._setVisible(f)
            }
    ...
    var d = function(b) {
        ...
        a.prototype.parseConfig = function(c) {
            ...
            for (var a = this.getConfigByKey(c[3], "count"), b = {}, e = 4; e < 4 + a; e++) {
                var d = c[e],
                    g = String.fromCharCode(this.getConfigByKey(d,
                        "id")),
                    h = {};
                b[g] = h;
        ...
        a.prototype.getConfigByKey = function(c, a) {
            for (var b = c.split(" "), e = 0, d = b.length; e < d; e++) {
                var g = b[e];
                if (a == g.substring(0, a.length)) return b = g.substring(a.length + 1), parseInt(b)
            }
            return 0
        };
        return a
...
(function(b) {
    var d = function(a) {
        function c(c, f) {
            a.call(this);
            this.frameRate = 60;
            c instanceof e ? (b.Logger.warning("MovieClip#constructor\u63a5\u53e3\u53c2\u6570\u5df2\u7ecf\u53d8\u66f4\uff0c\u8bf7\u5c3d\u5feb\u8c03\u6574\u7528\u6cd5\u4e3a new MovieClip(data,texture)"), this.delegate = c) : this.delegate = new e(c, f);
...
(function(b) {
    var d = function(b) {
        ...
        a.prototype._open = function(a, b, f, e) {};
    ...
    var d = function(e) {
        ...
        a.prototype.drawToTexture = function(c) {
            var k = this._bitmapData,
                f = c.getBounds(b.Rectangle.identity);
            if (0 == f.width || 0 == f.height) return b.Logger.warning("egret.RenderTexture#drawToTexture:\u663e\u793a\u5bf9\u8c61\u6d4b\u91cf\u7ed3\u679c\u5bbd\u9ad8\u4e3a0\uff0c\u8bf7\u68c0\u67e5"), !1;
            f.width = Math.floor(f.width);
            f.height = Math.floor(f.height);
            k.width = f.width;
            k.height = f.height;
            this.renderContext._cacheCanvas && (this.renderContext._cacheCanvas.width = f.width, this.renderContext._cacheCanvas.height = f.height);
            a.identityRectangle.width = f.width;
            a.identityRectangle.height = f.height;
            c._worldTransform.identity();
            c.worldAlpha = 1;
            if (c instanceof b.DisplayObjectContainer) {
                var k = c._anchorOffsetX,
                    e = c._anchorOffsetY;
                if (0 != c._anchorX || 0 != c._anchorY) k = c._anchorX * f.width, e = c._anchorY * f.height;
                this._offsetX = f.x + k;
                this._offsetY = f.y +
                    e;
                ...
                f = c._children;
                k = 0;
                for (e = f.length; k < e; k++) f[k]._updateTransform()
            }
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.clearRect = function(a, b, f, e) {};
        a.prototype.drawImage = function(a, b, f, e, d, g, h, m, p, q) {
        ...
        a.prototype.strokeRect = function(a, b, f, e, d) {};
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.dispatchEvent = function(a, k) {
            b.TouchEvent.dispatchTouchEvent(k.target, a, k.identifier, k.stageX,
                k.stageY, !1, !1, !1, !0 == this.touchDownTarget[k.identifier])
        };
        a.prototype.onTouchBegan = function(a, k, f) {
            if (this.touchingIdentifiers.length != this.maxTouches) {
                var e = b.MainContext.instance.stage.hitTest(a, k);
                e && (a = this.getTouchData(f, a, k), this.touchDownTarget[f] = !0, a.target = e, a.beginTarget = e, this.dispatchEvent(b.TouchEvent.TOUCH_BEGIN, a));
                this.touchingIdentifiers.push(f)
            }
        };
        a.prototype.onTouchMove = function(a, k, f) {
            if (-1 != this.touchingIdentifiers.indexOf(f) && (a != this.lastTouchX || k != this.lastTouchY)) {
                this.lastTouchX =
                    a;
                this.lastTouchY = k;
                var e = b.MainContext.instance.stage.hitTest(a, k);
                e && (a = this.getTouchData(f, a, k), a.target = e, this.dispatchEvent(b.TouchEvent.TOUCH_MOVE, a))
            }
        };
        a.prototype.onTouchEnd = function(a, k, f) {
            var e = this.touchingIdentifiers.indexOf(f); - 1 != e && (this.touchingIdentifiers.splice(e, 1), e = b.MainContext.instance.stage.hitTest(a, k)) && (a = this.getTouchData(f, a, k), delete this.touchDownTarget[f], f = a.beginTarget, a.target = e, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), f == e ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP,
...
(function(b) {
    var d = function(e) {
        ...
        a._getUrl = function(a) {
            var k = a.url; - 1 == k.indexOf("?") && a.method == b.URLRequestMethod.GET && a.data && a.data instanceof b.URLVariables && (k = k + "?" + a.data.toString());
            return k
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype._getHeader = function(a) {
            ...
            for (var b = ["webkit", "ms", "Moz", "O"], f = 0; f < b.length; f++)
                if (b[f] + "Transform" in a) return b[f];
            return ""
        };
        ...
        a.prototype.$ = function(c) {
            ...
            if (c = c instanceof HTMLElement ?
                c : k.querySelector(c)) c.find = c.find || this.$, c.hasClass = c.hasClass || function(a) {
...
(function(b) {
    var d = function() {
        ...
        e.parse = function(a) {
            ...
            for (var c = a.childNodes.length, k = !1, f = 0; f < c; f++) {
                var d = a.childNodes[f];
                if (1 == d.nodeType) {
                    k = !0;
                    break
                }
            }
            return k ? e.parseNode(d) : null
        };
        e.parseNode = function(a) {
            ...
            for (var b = a.attributes, f = b.length, d = 0; d < f; d++) {
                var l =
                    b[d],
                    g = l.name;
                0 != g.indexOf("xmlns:") && (c["$" + g] = l.value)
            }
            b = a.childNodes;
            f = b.length;
            for (d = 0; d < f; d++)
                if (l = e.parseNode(b[d])) c.children || (c.children = []), l.parent = c, c.children.push(l);!c.children && (a = a.textContent.trim()) && (c.text = a);
            return c
        };
        ...
        e.findByPath = function(a, c, b) {
            var f = c.indexOf("."),
                d; - 1 == f ? (d = c, f = !0) : (d = c.substring(0, f), c = c.substring(f + 1), f = !1);
            if (a = a.children)
                for (var l = a.length, g = 0; g < l; g++) {
                    var h = a[g];
                    h.localName ==
                        d && (f ? b.push(h) : e.findByPath(h, c, b))
                }
        };
...
(function(b) {
    ...
    var e = function() {
        ...
        a.prototype.ensureSpace = function(a) {
            if (a > this.maxlength) {
                ...
                var b = new ArrayBuffer(a),
                    f = new Uint8Array(this.arraybytes, 0, this.length);
                (new Uint8Array(b, 0, this.length)).set(f);
                this.arraybytes = b;
                this.maxlength = a
            }
        };
        ...
        a.prototype.readBytes = function(a, b, f) {
            void 0 === b && (b = 0);
            void 0 === f && (f = 0);
            null == f && (f = a.length);
            a.ensureWriteableSpace(b + f);
            var e = new Int8Array(a.arraybytes),
                d = new Int8Array(this.arraybytes);
            e.set(d.subarray(this.position, this.position + f), b);
            this.position += f;
            f + b > a.length && (a.length += f + b - a.length)
        };
        ...
        a.prototype.readUTFBytes = function(a) {
            var b = "";
            a = this.position + a;
            for (var f = new DataView(this.arraybytes); this.position < a;) {
                var e = f.getUint8(this.position++);
                if (128 > e) {
                    if (0 == e) break;
                    b += String.fromCharCode(e)
                } else if (224 > e) b += String.fromCharCode((e & 63) << 6 | f.getUint8(this.position++) & 127);
                else if (240 > e) var d = f.getUint8(this.position++),
                    b = b + String.fromCharCode((e & 31) << 12 | (d & 127) << 6 | f.getUint8(this.position++) & 127);
                else var d = f.getUint8(this.position++),
                    g = f.getUint8(this.position++),
                    b = b + String.fromCharCode((e & 15) << 18 | (d & 127) << 12 | g << 6 & 127 | f.getUint8(this.position++) & 127)
            }
            return b
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.removeTweens = function(c) {
            if (c.tween_count) {
                for (var b =
                    a._tweens, f = b.length - 1; 0 <= f; f--) b[f]._target == c && (b[f].paused = !0, b.splice(f, 1));
                c.tween_count = 0
            }
        };
        a.pauseTweens = function(a) {
            if (a.tween_count)
                for (var e = b.Tween._tweens, f = e.length - 1; 0 <= f; f--) e[f]._target == a && (e[f].paused = !0)
        };
        a.resumeTweens = function(a) {
            if (a.tween_count)
                for (var e = b.Tween._tweens, f = e.length - 1; 0 <= f; f--) e[f]._target == a && (e[f].paused = !1)
        };
        a.tick = function(c, b) {
            void 0 === b && (b = !1);
            for (var e = a._tweens.concat(), d = e.length - 1; 0 <= d; d--) {
                var l = e[d];
                b && !l.ignoreGlobalPause || l.paused || l.tick(l._useTicks ?
                    1 : c)
            }
        };
        a._register = function(c, e) {
            var f = c._target,
                d = a._tweens;
            if (e) f && (f.tween_count = f.tween_count ? f.tween_count + 1 : 1), d.push(c), a._inited || (b.Ticker.getInstance().register(a.tick, null), a._inited = !0);
            else
                for (f && f.tween_count--, f = d.length; f--;)
                    if (d[f] == c) {
                        d.splice(f, 1);
                        break
                    }
        ...
        a.prototype.setPosition = function(a, b) {
            ...
            if (this._target)
                ...
                for (var g = 0, h = this._steps.length; g < h && !(this._steps[g].t > e); g++);
                g = this._steps[g - 1];
                this._updateTargetProps(g, (this._stepPosition = e - g.t) / g.d)
            }
            0 != b && 0 < this._actions.length && (this._useTicks ? this._runActions(e, e) : 1 == b && e < l ? (l != this.duration && this._runActions(l, this.duration), this._runActions(0, e, !0)) : this._runActions(l, e));
            d && this.setPaused(!0);
        ...
        a.prototype._runActions = function(a, b, e) {
            ...
            var d = a,
                ...
                m = 1;
            a > b && (d = b, l = a, g = h, h = m = -1);
            for (;
                (g += m) != h;) {
                b = this._actions[g];
                var p = b.t;
                (p == l || p > d && p < l || e && p == a) && b.f.apply(b.o, b.p)
            }
        };
        a.prototype._updateTargetProps = function(c, b) {
            ...
            for (var h in this._initQueueProps) {
                null == (l = e[h]) && (e[h] = l = this._initQueueProps[h]);
                null ==
                    (g = d[h]) && (d[h] = g = l);
                l = l == g || 0 == b || 1 == b || "number" != typeof l ? 1 == b ? g : l : l + (g - l) * b;
                var m = !1;
                if (g = a._plugins[h])
                    for (var p = 0, q = g.length; p < q; p++) {
                        var r = g[p].tween(this, h, l, e, d, b, !!c && e == d, !c);
                        r == a.IGNORE ? m = !0 : l = r
                    }
                m || (this._target[h] = l)
            }
        ...
        a.prototype._appendQueueProps = function(c) {
            ...
            for (h in c)
                if (void 0 === this._initQueueProps[h]) {
                    e = this._target[h];
                    if (b = a._plugins[h])
                        for (d = 0, l = b.length; d < l; d++) e = b[d].init(this, h, e);
                    this._initQueueProps[h] = this._curQueueProps[h] = void 0 === e ? null : e
                }
            for (h in c) {
                e = this._curQueueProps[h];
                if (b = a._plugins[h])
                    for (g = g || {}, d = 0, l = b.length; d < l; d++) b[d].step && b[d].step(this, h, e, c[h], g);
...
(function(b) {
    var d = function(b) {
        ...
        __extends(a, b);
        a.dispatchResourceEvent = function(c, b, e, d, l, g) {
            void 0 === e && (e = "");
            void 0 === d && (d = null);
            void 0 === l && (l = 0);
            void 0 === g && (g = 0);
...
(function(b) {
    var d = function() {
        ...
        e.prototype.getGroupByName = function(a) {
            ...
            a = this.groupDic[a];
            for (var b = a.length, e = 0; e < b; e++) c.push(this.parseResourceItem(a[e]));
            return c
        };
            ...
            for (var e = [], d = c.length,
                ...
                if (h)
                    for (var g = h.length, m = 0; m < g; m++) {
                        var p = h[m]; - 1 == e.indexOf(p) && e.push(p)
                    } else(p = this.keyMap[g]) && -1 == e.indexOf(p) && e.push(p)
            }
            ...
            if (a) {
                ...
                if (b)
                    for (var e = b.length, d = 0; d < e; d++) {
                        var l = b[d],
                            g = l.url;
                        g && -1 == g.indexOf("://") && (l.url = c + g);
                        this.addItemToKeyMap(l)
                    }
                if (b = a.groups)
                    for (e = b.length, d = 0; d < e; d++) {
                        for (var g = b[d], h = [], m = g.keys.split(","), p = m.length, q = 0; q < p; q++) l = m[q].trim(), (l = this.keyMap[l]) && -1 == h.indexOf(l) && h.push(l);
    ...
    var d = function(e) {
        ...
        a.prototype.loadGroup = function(a, e, d) {
            ...
            if (!this.itemListDic[e] && e)
                if (a &&
                    0 != a.length) {
                    this.priorityQueue[d] ? this.priorityQueue[d].push(e) : this.priorityQueue[d] = [e];
                    this.itemListDic[e] = a;
                    d = a.length;
                    for (var n = 0; n < d; n++) a[n].groupName = e;
                    this.groupTotalDic[e] = a.length;
                    this.numLoadedDic[e] = 0;
                    this.next()
                } else egret.Logger.warning('RES\u52a0\u8f7d\u4e86\u4e0d\u5b58\u5728\u6216\u7a7a\u7684\u8d44\u6e90\u7ec4\uff1a"' + e + '"'), a = new b.ResourceEvent(b.ResourceEvent.GROUP_LOAD_ERROR), a.groupName = e, this.dispatchEvent(a)
        };
        ...
        a.prototype.onItemComplete = function(a) {
            ...
            if (!a.loaded) {
                ...
                if (d > this.maxRetryTimes) delete this.retryTimesDic[a.name], b.ResourceEvent.dispatchResourceEvent(this.resInstance,
            ...
            if (e) {
                ...
                b.ResourceEvent.dispatchResourceEvent(this.resInstance, b.ResourceEvent.GROUP_PROGRESS, e, a, d, n);
                d == n && (a = this.groupErrorDic[e], this.removeGroupName(e), delete this.groupTotalDic[e], delete this.numLoadedDic[e], delete this.itemListDic[e], delete this.groupErrorDic[e], a ? b.ResourceEvent.dispatchResourceEvent(this,
        ...
        a.prototype.removeGroupName = function(a) {
            for (var b in this.priorityQueue) {
                for (var e = this.priorityQueue[b], d = e.length, l = 0, g = !1, d = e.length, h = 0; h < d; h++) {
                    if (e[h] == a) {
                        e.splice(l, 1);
                        g = !0;
                        break
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.onLoadFinish = function(a) {
            ...
            d.loaded = a.type == egret.Event.COMPLETE;
            d.loaded && this.analyzeData(d, b.data);
            "string" == typeof b.data ? (this._dataFormat = egret.URLLoaderDataFormat.TEXTURE, this.loadFile(d, l, e.thisObject), this._dataFormat = egret.URLLoaderDataFormat.TEXT) : l.call(e.thisObject, d)
        };
        a.prototype.analyzeData = function(a, b) {
            var e = a.name;
            if (!this.fileDic[e] && b) {
                ...
                } else d = this.sheetMap[e], delete this.sheetMap[e], b && (d = this.parseSpriteSheet(b, d, a.data && a.data.subkeys ? "" : e), this.fileDic[e] = d)
            }
        };
        ...
        a.prototype.parseSpriteSheet = function(a, b, e) {
            ...
            for (g in b) {
                var h = b[g];
                a = d.createTexture(g, h.x, h.y, h.w, h.h,
                ...
                null == l[g] && (l[g] = a, e && this.addSubkey(g, e))
            }
            return d
        };
        return a
...
(function(b) {
    var d = function(b) {
        ...
        a.prototype.getTexturePath = function(a, b) {
            var e = "",
                d = b.split("\n")[2],
                l = d.indexOf('file="'); - 1 != l && (d = d.substring(l + 6), l = d.indexOf('"'), e = d.substring(0,
                l));
            a = a.split("\\").join("/");
            l = a.lastIndexOf("/");
            return a = -1 != l ? a.substring(0, l + 1) + e : e
        };
        return a
    }(b.SheetAnalyzer);
    b.FontAnalyzer = d;
...
(function(b) {
    ...
    b.addEventListener = function(a, c, b, d, n) {
        void 0 === d && (d = !1);
        void 0 === n && (n = 0);
        e.addEventListener(a, c, b, d, n)
    };
    b.removeEventListener = function(a, c, b, d) {
        void 0 === d && (d = !1);
        e.removeEventListener(a, c, b, d)
    };
    var d = function(a) {
        function c() {
            a.call(this);
        ...
        c.prototype.startLoadConfig = function() {
            ...
            for (var e = a.length, d = [], l = 0; l < e; l++) {
                var g = a[l],
        ...
        c.prototype.onGroupComp = function(a) {
            if (a.groupName == c.GROUP_CONFIG) {
                ...
                a = d.length;
                for (e = 0; e < a; e++) l = d[e], this.loadGroup(l.name, l.priority);
                this.groupNameList = []
        ...
        c.prototype.getResAsync = function(a, c, e) {
            ...
            if ("" == d && (g = b.AnalyzerBase.getStringPrefix(a), d = this.resConfig.getType(g), "" == d)) {
                c.call(e, null);
                return
        ...
        c.prototype.destroyRes = function(a) {
            ...
            if (c) {
                var b =
                    this.loadedGroups.indexOf(a); - 1 != b && this.loadedGroups.splice(b, 1);
                a = c.length;
                for (var e = 0; e < a; e++) {
                    b = c[e];
                    b.loaded = !1;
                    var d = this.getAnalyzerByType(b.type);
                    d.destroyRes(b.name)
                }
                return !0
            }
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.registerListener = function() {
            ...
            var l, g;
            "undefined" !== typeof document.hidden ? (l = "hidden", g = "visibilitychange") : "undefined" !== typeof document.mozHidden ? (l = "mozHidden", g = "mozvisibilitychange") : "undefined" !== typeof document.msHidden ? (l = "msHidden", g = "msvisibilitychange") : "undefined" !== typeof document.webkitHidden ?
                (l = "webkitHidden", g = "webkitvisibilitychange") : "undefined" !== typeof document.oHidden && (l = "oHidden", g = "ovisibilitychange");
            "onpageshow" in window && "onpagehide" in window && (window.addEventListener("pageshow", d, !1), window.addEventListener("pagehide", e, !1));
            l && g && document.addEventListener(g, n, !1)
        };
        return a
    }(b.DeviceContext);
    ...
    var d = function(e) {
        function a(a) {
            ...
            var b = this.canvasContext.setTransform,
                d = this;
            this._cacheCanvasContext.setTransform = function(a, c, e, h, m, p) {
                d._matrixA = a;
                d._matrixB =
                    c;
                d._matrixC = e;
                ...
                d._matrixTx = m;
                d._matrixTy = p;
                b.call(d._cacheCanvasContext, a, c, e, h, m, p)
            };
            this._matrixA = 1;
        ...
        a.prototype.drawImage = function(a, d, f, n, l, g, h, m, p, q) {
            void 0 === q && (q = void 0);
            var r = a._bitmapData;
            g += this._transformTx;
            h += this._transformTy;
            var t = b.getTimer();
            void 0 === q ? this._cacheCanvasContext.drawImage(r, d, f, n, l, g, h, m, p) : this.drawRepeatImage(a, d, f, n, l, g, h, m, p, q);
            e.prototype.drawImage.call(this, a, d, f, n, l, g, h, m, p, q);
            this.renderCost += b.getTimer() - t
        };
        a.prototype.drawRepeatImage =
            function(a, e, d, n, l, g, h, m, p, q) {
                if (void 0 === a.pattern) {
                    var r = b.MainContext.instance.rendererContext.texture_scale_factor,
                        t = a._bitmapData,
                        s = t;
                    if (t.width != n || t.height != l || 1 != r) s = document.createElement("canvas"), s.width = n * r, s.height = l * r, s.getContext("2d").drawImage(t, e, d, n, l, 0, 0, n * r, l * r);
                    e = this._cacheCanvasContext.createPattern(s, q);
                    a.pattern = e
                }
        ...
        a.prototype.drawText = function(a, d, f, n, l, g) {
            void 0 === g && (g = null);
            this.setupFont(a, g);
            g = g || {};
            var h;
            h = null != g.textColor ? b.toColorString(g.textColor) : a._textColorString;
            var m;
            m = null != g.strokeColor ? b.toColorString(g.strokeColor) : a._strokeColorString;
            var p;
            p = null != g.stroke ? g.stroke : a._stroke;
            var q = this._cacheCanvasContext;
            q.fillStyle = h;
            q.strokeStyle = m;
            p && (q.lineWidth = 2 * p, q.strokeText(d, f + this._transformTx, n + this._transformTy, l || 65535));
            q.fillText(d, f + this._transformTx, n + this._transformTy, l || 65535);
            e.prototype.drawText.call(this, a, d, f, n, l, g)
        };
        a.prototype.strokeRect = function(a, b, e, d, l) {
        ...
        a.prototype.onRenderFinish =
            function() {
                this._cacheCanvasContext.restore();
                this._cacheCanvasContext.setTransform(1, 0, 0, 1, 0, 0);
                for (var a = this._cacheCanvas.width, e = this._cacheCanvas.height, d = b.RenderFilter.getInstance().getDrawAreaList(), n = 0, l = d.length; n < l; n++) {
                    var g = d[n],
                        h = g.x,
                        m = g.y,
                        p = g.width,
                    ...
                    h + p > a && (p = a - h);
                    m + g > e && (g = e - m);
                    0 < p && 0 < g && this.canvasContext.drawImage(this._cacheCanvas, h, m, p, g, h, m, p, g)
                }
        };
        return a
    }(b.RendererContext);
...
(function(b) {
    ...
    b.drawRoundRect = function(b, a, c, k, f, n) {
        this.commandQueue.push(new d(function(a, b, c, e, d, f) {
            ...
            this.canvasContext.lineTo(a +
                d, e);
            this.canvasContext.quadraticCurveTo(a, e, a, e - f);
    ...
    b.lineStyle = function(b, a, c, k, f, n, l, g) {
        void 0 === b && (b = NaN);
        void 0 === a && (a = 0);
        void 0 === c && (c = 1);
        void 0 === k && (k = !1);
...
(function(b) {
    var d = function(e) {
        function a(a) {
            ...
            for (var d = 0, f = 0; d < a; d += 6, f += 4) this.indices[d + 0] = f + 0, this.indices[d + 1] = f + 1, this.indices[d + 2] = f + 2, this.indices[d + 3] = f + 0, this.indices[d + 4] = f + 2, this.indices[d + 5] = f + 3;
            this.initWebGL();
        ...
        a.prototype.clearScreen = function() {
            var a = this.gl;
            a.colorMask(!0, !0, !0, !0);
            for (var e = b.RenderFilter.getInstance().getDrawAreaList(), d = 0, n = e.length; d < n; d++) {
                var l = e[d];
        ...
        a.prototype.drawRepeatImage = function(a, e, d, n, l, g, h, m, p, q) {
            q = b.MainContext.instance.rendererContext.texture_scale_factor;
            n *= q;
            for (l *= q; g < m; g += n)
                for (var r = h; r < p; r += l) {
                    var t = Math.min(n, m - g),
                        s = Math.min(l, p - r);
                    this.drawImage(a, e, d, t / q, s / q, g, r, t, s)
                }
        };
        a.prototype.drawImage = function(a, b, e, d, l, g, h, m, p, q) {
            void 0 === q && (q = void 0);
            if (!this.contextLost)
                if (void 0 !==
                    q) this.drawRepeatImage(a, b, e, d, l, g, h, m, p, q);
                else {
                    ...
                    1 == d / m && 1 == l / p || r.append(m / d, 0, 0, p / l, 0, 0);
                    g = r.a;
                    h = r.b;
                    m = r.c;
                    p = r.d;
        ...
        a.prototype._draw = function() {
            if (0 != this.currentBatchSize && !this.contextLost) {
                ...
                var d = this.vertices.subarray(0,
...
(function(b) {
    ...
    var e = function() {
        ...
        a.prototype.init = function() {
            ...
            for (var e in this.uniforms) this.uniforms[e].uniformLocation = a.getUniformLocation(c, e);
            this.initUniforms();
            this.program = c
        };
    ...
    var d = function(e) {
        ...
        a.prototype.proceed = function(a) {
            ...
            if (a.dataFormat == b.URLLoaderDataFormat.TEXTURE) this.loadTexture(a);
                ...
                var l = b.NetContext._getUrl(d);
                n.open(d.method, l, !0);
                this.setResponseType(n, a.dataFormat);
                d.method != b.URLRequestMethod.GET && d.data ? d.data instanceof b.URLVariables ? (n.setRequestHeader("Content-Type",
                    "application/x-www-form-urlencoded"), n.send(d.data.toString())) : (n.setRequestHeader("Content-Type", "multipart/form-data"), n.send(d.data)) : n.send()
            }
        };
        a.prototype.loadSound = function(a) {
            function e(l) {
                window.clearTimeout(n.__timeoutId);
                n.removeEventListener("canplaythrough", e, !1);
            ...
            n.__timeoutId = window.setTimeout(e, 100);
            n.addEventListener("canplaythrough", e, !1);
    ...
    var d = function(e) {
        ...
        a.prototype.addTouchListener = function() {
            ...
            this.rootDiv.addEventListener("touchstart", function(b) {
                for (var e = b.changedTouches.length, d = 0; d < e; d++) a._onTouchBegin(b.changedTouches[d]);
                a.prevent(b)
            }, !1);
            this.rootDiv.addEventListener("touchmove",
                function(b) {
                    for (var e = b.changedTouches.length, d = 0; d < e; d++) a._onTouchMove(b.changedTouches[d]);
                    a.prevent(b)
                }, !1);
            this.rootDiv.addEventListener("touchend", function(b) {
                for (var e = b.changedTouches.length, d = 0; d < e; d++) a._onTouchEnd(b.changedTouches[d]);
                a.prevent(b)
            }, !1);
        ...
        a.prototype.getLocation = function(a, e) {
            var d = document.documentElement,
                n = window,
                l, g;
            "function" === typeof a.getBoundingClientRect ? (g = a.getBoundingClientRect(), l = g.left, g = g.top) : g = l = 0;
            l += n.pageXOffset - d.clientLeft;
            g += n.pageYOffset - d.clientTop;
            null != e.pageX ? (d = e.pageX, n = e.pageY) : (l -= document.body.scrollLeft,
                g -= document.body.scrollTop, d = e.clientX, n = e.clientY);
            var h = b.Point.identity;
            h.x = (d - l) / b.StageDelegate.getInstance().getScaleX();
            h.y = (n - g) / b.StageDelegate.getInstance().getScaleY();
            return h
        };
        return a
    }(b.TouchContext);
    ...
    var d = function(e) {
        function a() {
            ...
            var a = b.StageDelegate.getInstance().getScaleX(),
                ...
                f = b.Browser.getInstance().$new("div");
            f.position.x = 0;
            f.position.y = 0;
            f.scale.x = a;
            f.scale.y = d;
            f.transforms();
            f.style[egret_dom.getTrans("transformOrigin")] = "0% 0% 0px";
            this.div = f;
            d = b.MainContext.instance.stage;
            a = d.stageWidth;
            d = d.stageHeight;
        ...
        a.prototype._setScale = function(a, d) {
            ...
            this.div.scale.x = f * a;
            this.div.scale.y = n * d;
            this.div.transforms()
        };
...
var __extends = this.__extends || function(b, d) {
    ...
    Bao = function(b) {
        ...
        d.prototype.create = function() {
            ...
            this.bitmap.texture = RES.getRes("baoshi1");
            this.bitmap.width = 50;
            this.bitmap.height = 50;
            this.bitmap.x = 200;
            this.bitmap.y = 400;
            this.bitmap.touchEnabled = !0
        };
        d.prototype.setAnim = function(b) {
            b()
        };
        return d
    }(egret.Sprite);
Bao.prototype.__class__ = "Bao";
var JsonpReq = function() {
    function b() {}
    b.process = function(d) {
        b.completeCall["call_" + b._regID] = function(e) {
            var a = b._regID;
            d.data = e;
            d.dispatchEvent(new egret.Event(egret.Event.COMPLETE));
            delete b.completeCall["call_" + a]
        };
        b.startLoader(d, b._regID++)
    };
    b.startLoader = function(b, e) {
        var a = document.createElement("script");
        a.src = b._request.url + "JsonpReq.completeCall.call_" + e + "";
...
var __extends = this.__extends || function(b, d) {
    ...
    Wanbao = function(b) {
        function d() {
            b.call(this);
            this.zan = ["\u4f60\u771f\u725b", "\u725b\u903c\u903c\u903c\u903c", "\u5389\u5bb3"];
            this.xu = ["\u5931\u8bef\u4e86\u5427", "\u5f31\u4e86", "\u9760\u3002\u3002\u3002"];
            this.passnum = 0;
            this.bswrap = new egret.Sprite;
        ...
        d.prototype.onResourceLoadComplete = function(b) {
            "preload" == b.groupName && (this.stage.removeChild(this.loadingView), RES.removeEventListener(RES.ResourceEvent.GROUP_COMPLETE, this.onResourceLoadComplete, this), RES.removeEventListener(RES.ResourceEvent.GROUP_PROGRESS, this.onResourceProgress, this), this.init(), this.boomsound = RES.getRes("boomsound"), this.dingsound = RES.getRes("dingsound"))
        };
        d.prototype.onResourceProgress =
            function(b) {
        ...
        d.prototype.initObjs = function() {
            this.gamestage = new egret.Sprite;
            this.gamestage.width = this.stage.stageWidth;
            this.gamestage.height = this.stage.stageHeight;
            this.startstage = new egret.Sprite;
            this.startstage.width = this.stage.stageWidth;
            this.startstage.height = this.stage.stageHeight;
            this.liststage = new egret.Sprite;
            this.liststage.width = this.stage.stageWidth;
            this.liststage.height =
            ...
            this.helpbtn.texture = RES.getRes("btn_help");
            this.helpbtn.width = 50;
            this.helpbtn.height = 50;
            this.helpbtn.x = this.stage.stageWidth / 3;
            this.helpbtn.y = 400;
            this.helpbtn.touchEnabled = !0;
            this.helpbtn.alpha = 0;
            this.sunbtn = new egret.Bitmap;
            this.sunbtn.texture = RES.getRes("btn_sun");
            this.sunbtn.width = 50;
            this.sunbtn.height = 50;
            this.sunbtn.x = 2 * this.stage.stageWidth / 3;
            this.sunbtn.y = 400;
            this.sunbtn.touchEnabled = !0;
            this.sunbtn.alpha = 0;
            this.listbg = new egret.Bitmap;
            this.listbg.texture = RES.getRes("listbg");
            this.listbg.width = this.stage.stageWidth;
            this.listbg.height = this.stage.stageHeight;
            this.listbg.x = 0;
            this.listbg.y = 0;
            this.backbtn = new egret.Bitmap;
            this.backbtn.texture = RES.getRes("backbtn");
            this.backbtn.width = 50;
            this.backbtn.height = 50;
            this.backbtn.x = 60;
            this.backbtn.y = this.stage.stageHeight -
                100;
            this.backbtn.touchEnabled = !0;
            ...
            this.nextbtn = new egret.Bitmap;
            this.nextbtn.texture =
                RES.getRes("nextbtn");
            this.nextbtn.width = 50;
            this.nextbtn.height = 50;
            this.nextbtn.x = this.stage.stageWidth / 2 - 25;
            this.nextbtn.y = this.stage.stageHeight / 2 + 50;
            this.nextbtn.alpha = 0;
            this.nextbtn.touchEnabled = !0;
            this.listbtn = new egret.Bitmap;
            this.listbtn.texture = RES.getRes("listbtn");
            this.listbtn.width = 50;
            this.listbtn.height = 50;
            this.listbtn.x = this.stage.stageWidth - 80;
            this.listbtn.y = this.stage.stageHeight - 80;
            this.listbtn.alpha = 1;
            this.listbtn.touchEnabled = !0;
            this.gamestage.addChild(this.listbtn);
            this.replaybtn =
                new egret.Bitmap;
            this.replaybtn.texture = RES.getRes("replaybtn");
            this.replaybtn.width = 100;
            this.replaybtn.height = 100;
            this.replaybtn.x = this.stage.stageWidth / 2 - 100;
            ...
            this.getscorebtn.width = 100;
            this.getscorebtn.height = 100;
            this.getscorebtn.x = this.stage.stageWidth / 2 + 60;
            this.getscorebtn.y = this.stage.stageHeight / 2;
            this.getscorebtn.alpha =
                0;
            this.getscorebtn.touchEnabled = !0;
            ...
            this.boomer.y = 550;
            this.boomer.alpha = 1;
            this.boomer.touchEnabled = !0;
            this.man = new egret.Bitmap;
            this.man.texture = RES.getRes("man1");
            this.man.width = 50;
            this.man.height = 50;
            this.man.x = 25;
            this.man.y = this.stage.stageHeight - 100;
            this.man.alpha = 0;
            this.mansay = new egret.TextField;
            this.mansay.strokeColor = 0;
            this.mansay.stroke = 1;
            this.mansay.text = "\u4f4e\u8c03\u4f4e\u8c03\u4f4e\u8c03\u4f4e\u8c03\u4f4e\u8c03\u4f4e\u8c03\u4f4e\u8c03\u4f4e\u8c03";
            this.mansay.width = 300;
            this.mansay.height = 25;
            this.mansay.x = 80;
            this.mansay.y = this.stage.stageHeight - 90;
            this.mansay.size = 25;
            this.mansay.fontFamily = "\u5fae\u8f6f\u96c5\u9ed1";
            this.mansay.alpha = 0;
            this.bswrap.name = "bswrap";
            this.bswrap.x = 0;
            this.bswrap.y = 0;
        ...
        d.prototype.initchilds = function() {
            this.startstage.addChild(this.startbg);
            this.startstage.addChild(this.startbtn);
            this.liststage.addChild(this.listbg);
            this.liststage.addChild(this.backbtn);
            this.gamestage.addChild(this.stage1bg);
            this.gamestage.setChildIndex(this.stage1bg, 0);
            this.gamestage.addChild(this.boom);
            this.gamestage.addChild(this.scorebar);
            this.gamestage.addChild(this.replaybtn);
            this.gamestage.addChild(this.getscorebtn);
            this.gamestage.addChild(this.man);
            this.gamestage.addChild(this.mansay);
            this.gamestage.addChild(this.helpbtn);
            this.gamestage.addChild(this.sunbtn);
            this.addChild(this.startstage)
        };
        d.prototype.regEvents =
            function() {
                this.startbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function(b) {
                    this.startstage && this.removeChild(this.startstage);
                    this.addChild(this.gamestage);
                    this.initStage1()
                }, this);
                this.listbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function(b) {
                    this.gamestage && this.removeChild(this.gamestage);
                    this.addChild(this.liststage)
                    wawa.showPaihang();
                }, this);
                this.backbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, function() {
                    this.liststage && this.removeChild(this.liststage);
                    this.addChild(this.gamestage)
                    wawa.hidePaihang();
                }, this)
        };
        d.prototype.init =
            function() {
                this.passnum = this.score = 0;
                this.initObjs();
                this.initchilds();
                this.regEvents()
        };
        d.prototype.initStage1 = function() {
            this.currentStage = 1;
            this.playStage()
        };
        d.prototype.playStage = function() {
            var b = this.stage.stageHeight,
                a = this.stage.stageWidth;
            this.gamestage && (this.gamestage.addChild(this.boomer), this.boom.alpha = 0, this.replaybtn.alpha = 0, this.getscorebtn.alpha = 0, this.man.alpha = 0, this.mansay.alpha = 0, this.nextbtn.alpha = 0, this.helpbtn.alpha = 0, this.sunbtn.alpha = 0, this.timer.stop(), this.helpbtn.removeEventListener(egret.TouchEvent.TOUCH_TAP,
                this.helpTouch, this), this.sunbtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.sunTouch, this), this.gamestage.getChildByName("bswrap") && (this.bswrap.removeChildren(), this.gamestage.removeChild(this.gamestage.getChildByName("bswrap"))));
            if (1 == this.currentStage) {
                var c = new egret.Bitmap;
                c.texture = RES.getRes("baoshi1");
                c.width = 50;
                c.height = 50;
                c.x = a / 3;
                c.y = 5 * b / 8;
                ...
                this.boomer.alpha =
                    0.1;
                this.bswrap.addChild(c);
                this.bswrap.addChild(d);
                this.bswrap.addChild(this.nextbtn);
                ...
                this.timer.addEventListener(egret.TimerEvent.TIMER_COMPLETE,
                    function() {
                        c.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                        d.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                        this.boomer.addEventListener(egret.TouchEvent.TOUCH_TAP, this.boomerTouch, this)
                    }, this);
                this.timer.start();
                this.gamestage.addChild(this.bswrap);
                egret.Tween.get(this.boomer, {
                    loop: !1
                }).to({
                    x: this.stage.stageWidth / 2 - 25
                }, 200)
            }
            if (2 == this.currentStage) {
                c = new egret.Bitmap;
                c.texture = RES.getRes("baoshi1");
                c.width = 50;
                c.height = 50;
                ...
                this.bswrap.addChild(c);
                this.bswrap.addChild(d);
                this.bswrap.addChild(f);
                this.bswrap.addChild(this.nextbtn);
                this.gamestage.addChild(this.boomer);
                this.gamestage.addChild(this.bswrap);
                this.boomer.alpha = 0.1;
                this.timer.addEventListener(egret.TimerEvent.TIMER, function() {
                    egret.Tween.get(c, {
                        loop: !1
                    }).to({
                ...
                this.timer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, function() {
                    c.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    d.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    f.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    this.boomer.addEventListener(egret.TouchEvent.TOUCH_TAP, this.boomerTouch, this)
                }, this);
                this.timer.start();
                egret.Tween.get(this.boomer, {
            ...
            if (3 ==
                ...
                this.timer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, function() {
                    c.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    d.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    f.addEventListener(egret.TouchEvent.TOUCH_TAP,
                        this.diamondTouch, this);
                    n.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    this.boomer.addEventListener(egret.TouchEvent.TOUCH_TAP, this.boomerTouch, this)
                }, this);
                this.timer.start();
                egret.Tween.get(this.boomer, {
            ...
            if (4 == this.currentStage) {
                ...
                this.timer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, function() {
                    ...
                    f.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    n.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    l.addEventListener(egret.TouchEvent.TOUCH_TAP,
                        this.diamondTouch, this);
                    this.boomer.addEventListener(egret.TouchEvent.TOUCH_TAP, this.boomerTouch, this)
                }, this);
                this.timer.start();
            ...
            if (5 == this.currentStage) {
                ...
                this.timer.addEventListener(egret.TimerEvent.TIMER_COMPLETE, function() {
                    ...
                    f.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    n.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    l.addEventListener(egret.TouchEvent.TOUCH_TAP, this.diamondTouch, this);
                    g.addEventListener(egret.TouchEvent.TOUCH_TAP,
                        this.diamondTouch, this);
                    this.boomer.addEventListener(egret.TouchEvent.TOUCH_TAP, this.boomerTouch, this)
                }, this);
                this.timer.start();
        ...
        d.prototype.diamondTouch = function(b) {
            this.bswrap && this.bswrap.removeChild(b.target);
            this.dingsound.play();
            this.passnum++;
            this.score += 500;
            this.man.alpha = 1;
            ...
            this.scorebar.text = "\u5f53\u524d\u79ef\u5206 : " +
                this.score;
            1 == this.currentStage && 2 == this.passnum && (egret.Tween.get(this.succ, {
                loop: !1
            }).to({
                alpha: 1
            }, 200), this.mansay.text = "\u597d\u6d41\u5f0a,\u606d\u559c\u8fc7\u5173\uff01", this.gamestage.removeChild(this.boomer), this.nextbtn.alpha = 1, this.currentStage = 2, this.nextbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.nextStageTouch, this));
            2 == this.currentStage && 3 == this.passnum && (egret.Tween.get(this.succ, {
                    loop: !1
                }).to({
                    alpha: 1
                }, 200), this.mansay.text = "so diao,\u606d\u559c\u8fc7\u7b2c\u4e8c\u5173\uff01",
                this.gamestage.removeChild(this.boomer), this.nextbtn.alpha = 1, this.currentStage = 3, this.nextbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.nextStageTouch, this));
            3 == this.currentStage && 4 == this.passnum && (egret.Tween.get(this.succ, {
                loop: !1
            }).to({
                alpha: 1
            }, 200), this.mansay.text = "\u597d\u6d41\u5f0a\u54e6,\u8fc7\u7b2c\u4e09\u5173\uff01", this.gamestage.removeChild(this.boomer), this.nextbtn.alpha = 1, this.currentStage = 4, this.nextbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.nextStageTouch, this));
            4 ==
                this.currentStage && 5 == this.passnum && (egret.Tween.get(this.succ, {
                    loop: !1
                }).to({
                    alpha: 1
                }, 200), this.mansay.text = "\u597d\u6d41\u5f0a\u54e6,\u8fc7\u7b2c\u56db\u5173\uff01\uff01\uff01", this.gamestage.removeChild(this.boomer), this.nextbtn.alpha = 1, this.currentStage = 5, this.nextbtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.nextStageTouch, this));
            5 == this.currentStage && 6 == this.passnum && (egret.Tween.get(this.succ, {
                    loop: !1
                }).to({
                    alpha: 1
                }, 200), this.mansay.text = "\u597d\u6d41\u5f0a\u54e6,\u8fc7\u7b2c\u4e94\u5173\uff01\uff01\uff01",
                this.gamestage.removeChild(this.boomer), this.currentStage = 6)
        };
        d.prototype.helpTouch = function(b) {
            console.log(this.helpbtn);
            this.initStage1()
        };
        d.prototype.sunTouch = function(b) {
            console.log(this.sunbtn);
            this.initStage1()
        };
        d.prototype.boomerTouch = function(b) {
            this.gamestage && this.gamestage.removeChild(b.target);
            this.bswrap.removeChildren();
            this.boomsound.play();
            this.boomer.alpha = 0;
            this.boom.x = b.stageX - 240;
            this.boom.y = b.stageY - 420;
            this.boom.alpha = 1;
            ...
            this.mansay.alpha = 1;
            this.score = 100 < this.score ? this.score - 100 : 0;
            this.scorebar.text = "\u5f53\u524d\u79ef\u5206 : " + this.score;
            this.replaybtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.replayTouch, this);
            this.getscorebtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.getscoreTouch, this)
        };
        d.prototype.getscoreTouch = function(b) {
            wawa.updateScore('10000',12233243);
        };
        d.prototype.replayTouch = function(b) {
            this.passnum = this.score = 0;
            this.playStage()
        };
        d.prototype.nextStageTouch =
            function(b) {
                this.passnum = 0;
                this.nextbtn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.nextStageTouch, this);
                this.playStage()
        };
        return d
